...
class InvitesControllerTest < ActionController::TestCase
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post :create, invite: { accepted: @invite.accepted, invited: @invite.invited, team: @invite.team, user: @invite.user }
    end
  ...
  test "should update invite" do
    patch :update, id: @invite, invite: { accepted: @invite.accepted, invited: @invite.invited, team: @invite.team, user: @invite.user }
    assert_redirected_to invite_path(assigns(:invite))
  end
